...
console.log(today) //2025-11-18T07:00:24.969Z
...
//date time format
const startBooking1 = new Date("2025-11-15T12:00:00")
const stopBooking1 = new Date("2025-11-16T12:00:00")
 
console.log(stopBooking1.toISOString()) //2025-11-16T05:00:00.000Z
console.log(stopBooking1.toString()) //Sun Nov 16 2025 12:00:00 GMT+0700 (Indochina Time)
console.log(
  stopBooking1.toLocaleString("th-TH", {
    dateStyle: "full",
    timeStyle: "full",
  })
...
console.log(formatter.format(stopBooking1))
